	...
	<xsl:template match="/">
		<fo:root>
			...
			<fo:layout-master-set>
				<fo:simple-page-master master-name="simple"
					page-height="34cm" page-width="21.59cm" margin-top="0.5cm"
					...
					<fo:block white-space-treatment="preserve" font-family="sans-serif"
						...
						<fo:table table-layout="fixed" width="21.5cm" >
							...
							<fo:table-row>
								...
								<fo:table-row>
									<fo:table-cell>
									 <fo:block   font-size="8pt" font-family="Helvetica, Arial, sans" line-height="7pt" text-align="left" padding-bottom="1pt">
										</fo:block>
									</fo:table-cell>
									<fo:table-cell>
									 <fo:block   font-size="8pt" font-family="Helvetica, Arial, sans" line-height="7pt" text-align="left" padding-bottom="1pt">
									...
									<fo:table-cell>
									 <fo:block   font-size="10pt" font-family="Helvetica, Arial, sans" line-height="7pt" text-align="right" padding-bottom="1pt">
										</fo:block>
									</fo:table-cell>
									<fo:table-cell  text-align="center">
									 <fo:block   font-size="10pt" font-family="Helvetica, Arial, sans" line-height="7pt" text-align="center" padding-bottom="1pt">
										Sheet No: <fo:leader leader-length="5mm"/><fo:inline  font-size="10pt"><fo:page-number/>
										<!-- <xsl:value-of select="//pageno"/>  <fo:page-number/> --></fo:inline>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>	
		...
		<xsl:template name="header">
			<fo:table table-layout="fixed" width="19cm">
							...
							<fo:table-body>
							<fo:table-row>
								<!-- <fo:table-cell  display-align="center"  height="0.6cm" text-align="center">
											<fo:block  font-family="Helvetica, Arial, sans" line-height="15pt" font-size="10px">
												<fo:external-graphic height="0.9cm" width="1cm" src="../Bihar-Police-constable-recruitment-1.jpg">
							               	</fo:external-graphic>
											</fo:block>
								</fo:table-cell> -->
								<fo:table-cell   display-align="center"  height="0.6cm" text-align="left">
											<fo:block  font-family="Helvetica, Arial, sans" line-height="15pt" font-size="10px">
											<fo:inline margin-top="1cm">
											<fo:external-graphic height="0.7cm" width="15cm" src="../steno_header_04-08-2021.jpg">
							               	</fo:external-graphic></fo:inline> 
												<fo:inline text-align="end"> <fo:leader leader-length="13mm"/>Page 
												<fo:page-number /> of <fo:page-number-citation ref-id="TheVeryLastPage"/>
											...
											<fo:block  font-size="9pt" font-family="Helvetica, Arial, sans" line-height="18pt" text-align="left" padding-bottom="1pt">
												Centre :   <xsl:value-of select="//center_name"/><!--  - <xsl:value-of select="//typing_lab"/>  -->
											 </fo:block> 
								</fo:table-cell>
							</fo:table-row>
