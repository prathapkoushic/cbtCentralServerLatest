	...
	<div id="page-title">
		<div class="panel">
			<div class="panel-body">
				<h3 class="title-hero">
					<b>push Candidate Answers</b>
				</h3>
				<div class="example-box-wrapper">
					<form class="form-horizontal bordered-row"
						action="pushCandidateAnswersUrl" method="POST"
						...
						<p style="text-align: center; color: red;">${candidate_qa_count_percentage_msg}</p>
						<%
							Integer candidate_qa_count_percentage = (Integer) request.getAttribute("candidate_qa_count_percentage");

							if (candidate_qa_count_percentage != null) {
						%>
						<div class="form-group">
							<label class="col-sm-2 control-label"></label>
							<div class="col-sm-7">
								<div class="progressbar "
									data-value="<%=candidate_qa_count_percentage%>"
									id="whole_width">
									<div class="progressbar-value bg-green" id="bar_width">
										<div class="progress-label"><%=candidate_qa_count_percentage%>
										</div>
									</div>
								</div>
							</div>
							<div class="col-sm-2">
								<b>${competedRecords} of ${totalRecords}</b>
							</div>
						</div>
						<%
							}
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button id="submit" type="submit"
									class="btn btn-primary mgn-top">Push Candidate Answers</button>
							</div>
						</div>
